...
# get node properties
t9$get_node_table(node_roles = TRUE)
...
library(ggraph)
t9$plot_network(method = "ggraph", node_color = "Phylum")

#plot network using networkD3
library(networkD3)
t9$plot_network(method = "networkD3", node_color = "module")

# create trans_env object
t9.heatmap <- trans_env$new(dataset = Oct23_16S.056.a.micro.c, add_data = Oct23_16S.056.a.micro.c$sample_table[, 7:13])
# calculate correlations
t9.heatmap$cal_cor(add_abund_table = t9$res_eigen)
# plot the correlation heatmap
t9.heatmap$plot_cor(filter_feature = "")

t9$cal_sum_links(taxa_level = "Genus")
# require chorddiag package; see https://github.com/mattflor/chorddiag

library(chorddiag)
t9$plot_sum_links(plot_pos = TRUE, plot_num = 20)
